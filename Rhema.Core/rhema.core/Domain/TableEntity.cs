...
namespace NavyBule.Core.Domain
{
    internal class TableEntity
    {
        ...
        public string KeyPropertyName { get; set; } // 主键屬性名稱對應欄位
        public Type KeyType { get; set; } //主键类型
        public bool IsIdentity { get; set; } //是否是自增键


        public List<string> AllFieldList { get; set; } //所有列
        public List<string> AllFieldPropertiesList { get; set; } //所有列
        public List<string> ExceptKeyFieldList { get; set; } //除主键列
        public List<string> ExceptKeyAllFieldPropertiesList { get; set; } //除主键列
        public Dictionary<string,string> ExceptKeyAllFieldPropertiesMap { get; set; } //除主键列 屬性名稱對應欄位
        public Dictionary<string, string> AllFieldPropertiesMap { get; set; } // 屬性名稱對應欄位
        //保留主键
